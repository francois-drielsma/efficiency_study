...
cp -r ${paper_source}/compare_data ${paper_target}/first_observation_of_emittance_reduction/03-Detectors/Figures
cp -r ${paper_source}/compare_optics ${paper_target}/first_observation_of_emittance_reduction/04-Cooling-Channel/Figures
cp -r ${paper_source}/compare_amplitude_* ${paper_target}/first_observation_of_emittance_reduction/05-Results/Figures
