...
class Config(object):
    ...
    void = [ # 
        {
            "plot_dir":data_dir+"plots_140MeVc-diff-1111-q789-25pc/",
            "tof12_cut_low":32.,
            "tof12_cut_high":39.,
            "tof01_cut_low":28.,
            "tof01_cut_high":33.,
            ...
            "p_tot_ds_low":80.,
            "p_tot_ds_high":200.,
            "reco_files":file_names([8609, 8610], "MAUS-v2.6.5"),
            "name":"6-140+M3-diff-1111-q789-25pc",
            "color":4,
            "pid":-13, # tof cut -> muon peak
            "do_amplitude":False
        },]
    void = [{
            ...
            "p_tot_ds_low":80.,
            "p_tot_ds_high":200.,
            "reco_files":file_names([8596,], "MAUS-v2.6.5"),
            "name":"6-140+M3-Test2",
            "color":4,
            "pid":-13, # tof cut -> muon peak
        },
