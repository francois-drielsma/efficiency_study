...
def get_analysis(run_list, name, tof01_max, maus_version, data_dir, extrap, amplitude_source):
    ...
    return {
            ...
            "tof12_cut_low":29., # TOF12 cut lower bound
            "tof12_cut_high":32., # TOF12 cut upper bound
...
class Config(object):
    geometry = "geometry_09620/ParentGeometryFile.dat" #
    # location to which data and plots will be dumped following analysis
    data_dir = "output/straights-2017-09-21/"
    info_file = "geometry_09620/Maus_Information.gdml"
    ...
    analyses = []
    analyses.append(get_analysis([9628], "9628", 37., "MAUS-v2.9.1", data_dir, "tku_tp", ""))
    analyses.append(get_analysis([9629], "9629", 37., "MAUS-v2.9.1", data_dir, "tku_tp", ""))
    #analyses.append(get_analysis([9630], "9630", 37., "MAUS-v2.9.1", data_dir, "tku_tp", ""))
