...
class CompareCutsConfig(CompareConfig):
    def __init__(self, beam):
        self.setup(beam, "output/2017-02/", "cut_plots/", "compare_cuts/", True, True)
        self.conglomerate_list = [
            #self.get_conglomerate_2("global_through_virtual_diffuser_ds_r_10_0", None, "Radius at diffuser (upstream) [mm]", None, True, [0.5, 0.5, 0.9, 0.9]),
            #self.get_conglomerate_2("global_through_virtual_diffuser_us_r_10_0", None, "Radius at diffuser (downstream) [mm]", None, True, [0.5, 0.5, 0.9, 0.9]),
            self.get_conglomerate_2("tkd_n_tracks_15_0", None, "Number of tracks in TKD", None, True, [0.5, 0.5, 0.9, 0.9]),
            self.get_conglomerate_2("tkd_chi2_15_0", None, "#chi^{2}/D.o.F. in TKD", None, True, [0.5, 0.5, 0.9, 0.9]),
            self.get_conglomerate_2("tkd_max_r_15_0", None, "Maximum radius in TKD [mm]", None, True, [0.5, 0.5, 0.9, 0.9]),
            self.get_conglomerate_2("tkd_p_15_0", None, "Momentum in TKD [MeV/c]", None, True, [0.5, 0.5, 0.9, 0.9]),
            self.get_conglomerate_2("tku_chi2_10_0", None, "#chi^{2}/D.o.F. in TKU", None, True, [0.5, 0.5, 0.9, 0.9]),
            self.get_conglomerate_2("tku_max_r_10_0", None, "Maximum radius in TKU [mm]", None, True, [0.5, 0.5, 0.9, 0.9]),
            self.get_conglomerate_2("tku_n_tracks_9_0", None, "Number of tracks in TKU", None, True, [0.5, 0.5, 0.9, 0.9]), # disable two cuts
            self.get_conglomerate_2("tku_p_10_0", None, "Momentum in TKU [MeV/c]", None, True, [0.1, 0.5, 0.4, 0.9]),
            self.get_conglomerate_2("tof_tof0_n_sp_10_0", None, "Number of space points in TOF0", None, True, [0.5, 0.5, 0.9, 0.9]),
            self.get_conglomerate_2("tof_tof1_n_sp_10_0", None, "Number of space points in TOF1", None, True, [0.5, 0.5, 0.9, 0.9]),
            self.get_conglomerate_2("tof_tof01_10_0", None, "Time between TOF0 and TOF1 [ns]", None, True, [0.1, 0.5, 0.5, 0.9]),
            self.get_conglomerate_2("tof_delta_tof01_10_0", None, "t(TOF01) - extrapolated t(TOF01) [ns]", None, True, [0.1, 0.5, 0.5, 0.9]),

            self.get_conglomerate_2("tku_scifi_n_planes_with_clusters_11_0", None, "Number of planes with clusters in TKU", None, True, [0.1, 0.5, 0.5, 0.9]),
            self.get_conglomerate_2("tku_scifi_n_planes_with_clusters_9_0",  None, "Number of planes with clusters in TKU", None, True, [0.1, 0.5, 0.5, 0.9]),
            self.get_conglomerate_2("tku_scifi_n_planes_with_clusters_9_1",  None, "Number of planes with clusters in TKU", None, True, [0.1, 0.5, 0.5, 0.9]),
            ...
            self.get_conglomerate_2("tkd_scifi_n_planes_with_clusters_12_1", None, "Number of planes with clusters in TKD", None, True, [0.1, 0.5, 0.5, 0.9]),
            self.get_conglomerate_2("tkd_scifi_n_planes_with_clusters_16_0", None, "Number of planes with clusters in TKD", None, True, [0.1, 0.5, 0.5, 0.9]),
        ]
...
class CompareData1DConfig(CompareConfig):
    def __init__(self, beam):
        self.setup(beam, "output/2017-02/", "data_plots/", "compare_data/", True, True)
        ...
        self.conglomerate_list = [
            ...
            self.get_conglomerate_1("tku_x",  "tku_x",  "us_cut", "x in TKU [mm]",        None, False, [0.55, 0.5, 0.9, 0.9]),
            self.get_conglomerate_1("tku_y",  "tku_y",  "us_cut", "y in TKU [mm]",        None, False, [0.55, 0.5, 0.9, 0.9]),
            self.get_conglomerate_1("tku_px", "tku_px", "us_cut", "p_{x} in TKU [MeV/c]", None, False, [0.55, 0.5, 0.9, 0.9]),
            self.get_conglomerate_1("tku_py", "tku_py", "us_cut", "p_{y} in TKU [MeV/c]", None, False, [0.55, 0.5, 0.9, 0.9]),
            self.get_conglomerate_1("tku_p", "tku_p", "us_cut", "p in TKU [MeV/c]", None, False, [0.55, 0.5, 0.9, 0.9]),
            self.get_conglomerate_1("tkd_x",  "tkd_x",  "ds_cut", "x in TKD [mm]",        None, False, [0.55, 0.5, 0.9, 0.9]),
            self.get_conglomerate_1("tkd_y",  "tkd_y",  "ds_cut", "y in TKD [mm]",        None, False, [0.55, 0.5, 0.9, 0.9]),
            self.get_conglomerate_1("tkd_px", "tkd_px", "ds_cut", "p_{x} in TKD [MeV/c]", None, False, [0.55, 0.5, 0.9, 0.9]),
            self.get_conglomerate_1("tkd_py", "tkd_py", "ds_cut", "p_{y} in TKD [MeV/c]", None, False, [0.55, 0.5, 0.9, 0.9]),
            self.get_conglomerate_1("tkd_p", "tkd_p", "ds_cut", "p in TKD [MeV/c]", None, False, [0.55, 0.5, 0.9, 0.9]),
        ]


class CompareData2DConfig(CompareConfig):
    def __init__(self, beam):
        self.setup(beam, "output/2017-02/", "data_plots/", "compare_data/", True, False)
...
class CompareOpticsConfig(CompareConfig):
    def __init__(self, beam):
        self.setup(beam, "output/2017-02/", "optics_plots/", "compare_optics/", True, False)
...
class CompareGlobalsConfig(CompareConfig):
    def __init__(self, beam):
        self.setup(beam, "output/2017-02/", "global_plots/", "compare_globals/", True, False)
...
class CompareAmplitudeConfigMC(CompareConfig): # MC corrections
    def __init__(self, beam):
        self.setup(beam, "output/2017-02/", "amplitude/", "compare_amplitude_mc/", False, True)
...
class CompareAmplitudeConfigData(CompareConfig): # data plots
    def __init__(self, beam):
        self.setup(beam, "output/2017-02/", "amplitude/", "compare_amplitude_data/", True, False)
        ...
        self.conglomerate_list = [
            ...
            self.get_conglomerate_graph("amplitude_cdf_reco", "Reconstructed Amplitude [mm]",
                                        ...
                                        ["Upstream_CDF", "Downstream_CDF"]), 
        ]

class CompareAmplitudeConfigBoth(CompareConfig): # comparisons
    def __init__(self, beam):
        self.setup(beam, "output/2017-02/", "amplitude/", "compare_amplitude_both/", True, True)
        ...
        self.conglomerate_list = [
            self.get_conglomerate_graph("pdf_ratio*", "Reconstructed Amplitude [mm]",
                                        ...
                                        ["PDF_Ratio"], x_range = [0., 100.], y_range = [0., 4.], replace_hist = True,
                                        graph_marker_style=[24, 26], graph_marker_color=[4, ROOT.kYellow+2]),
            ...
            self.get_conglomerate_graph("cdf_ratio*", "Reconstructed Amplitude [mm]",
                                        ...
                                        ["CDF_Ratio"], x_range = [0., 100.], y_range = [0., 4.], replace_hist = True,
                                        graph_marker_style=[24, 26], graph_marker_color=[4, ROOT.kYellow+2]),
        ]

def cuts_summary(dir_list):
...
def run_conglomerate(batch_level, config_list, dir_lists, do_cuts_summary = False):
    rows = len(dir_lists)
...
def main(batch_level = 0):
    ...
    config_list = [CompareCutsConfig, CompareOpticsConfig, CompareData1DConfig, CompareData2DConfig]
    #config_list = [CompareAmplitudeConfigData]#, CompareAmplitudeConfigMC]
    config_list = [CompareAmplitudeConfigBoth]
    batch_level = 0
    hide_root = False
    if batch_level < 10 and hide_root:
        ROOT.gErrorIgnoreLevel = 6000
    run_conglomerate(batch_level, config_list, my_dir_list, True)


if __name__ == "__main__":
    utilities.set_palette()
    main()
